...
export type FormFieldsType = { name: string, size: number, label?: string, required: boolean, errorMessage?: string, type: 'textfield' | 'select' | 'checkbox', shouldErrorOn?: string[], multiline?: boolean, maxRows?: number, number?: boolean }[];
