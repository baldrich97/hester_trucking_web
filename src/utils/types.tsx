...
export type FormFieldsType = { name: string, size: number, label?: string, required: boolean, errorMessage?: string, type: 'textfield' | 'select' | 'checkbox' | 'date', shouldErrorOn?: string[], multiline?: boolean, maxRows?: number, number?: boolean, disabled?: boolean}[];
