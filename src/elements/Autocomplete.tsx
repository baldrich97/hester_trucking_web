...
const BasicAutocomplete = ({
                               ...
                               searchQuery,
                               onSelect
                           }: { defaultValue?: string | number | null, label: string, data?: Array<any>, optionLabel: string, optionValue: string, searchQuery: string, onSelect: any }) => {
    ...
    const [value, setValue] = useState(defaultValue ? data.find((item) => {
