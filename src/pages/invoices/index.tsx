...
const Invoices = ({
    ...
    trpc.useQuery(
        ["invoices.getAllUnpaid", {customer, loadType, deliveryLocation, search, page, orderBy, order}],
        {
    ...
    trpc.useQuery(
        ["invoices.getAllConsolidated", {customer, loadType, deliveryLocation, search, page, orderBy, order}],
        {
    ...
    trpc.useQuery(
        ["invoices.getAllPaid", {customer, loadType, deliveryLocation, search, page, orderBy, order}],
        {
    ...
    trpc.useQuery(
        ["invoices.getAll", {customer, loadType, deliveryLocation, search, page, orderBy, order}],
        {
    ...
    trpc.useQuery(["invoices.getCount", {customer, loadType, deliveryLocation, search, tabValue}], {
            ...
            <Grid2 xs={8} sx={{paddingRight: 2.5}}>
                ...
                {tabValue === 0 && (
                    <GenericTable
                        ...
                        searchSet={(customer !== 0 && customer !== undefined && customer !== null) || (loadType !== 0 && loadType !== undefined && loadType !== null) || (deliveryLocation !== 0 && deliveryLocation !== undefined && deliveryLocation !== null) || (search !== null)}
                        doSearch={() => {
                            setPage(0);
                            setShouldRefresh(true);
                        }}
