    ...
    useEffect(() => {
        ...
        if (info_shown) {
            ...
            if (!_info_shown?.dailies) {
                toast('Invoices are comprised of Weeklies. To generate an invoice, you have to first close a weekly for a customer.', {
                    autoClose: 100000,
                    type: "info"
                })

                window.localStorage.setItem('info_shown', JSON.stringify({..._info_shown, 'invoices': true}))
            }
        } else {
            toast('Invoices are comprised of Weeklies. To generate an invoice, you have to first close a weekly for a customer.', {
                autoClose: 100000,
            ...
            window.localStorage.setItem('info_shown', JSON.stringify({'invoices': true}))
        }
