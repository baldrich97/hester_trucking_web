                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <Box sx={{ margin: 1 }}>
                            ...
                            <Table size="small" aria-label="purchases">
                                <TableHead>
                                    <TableRow>
                                        <TableCell align="left" padding="none" size={'small'}>Driver</TableCell>
                                        <TableCell align="left" padding="none" size={'small'}>Truck</TableCell>
                                        <TableCell align="left" padding="none" size={'small'}>Type</TableCell>
                                        <TableCell align="left" padding="none" size={'small'}>Location</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
...
export default function InvoiceLoads({readOnly, rows, updateTotal, updateSelected}: {readOnly: boolean, rows: any[], updateTotal: any, updateSelected: any}) {
    ...
    const handleClick = (event: React.MouseEvent<unknown>, ID: string, TotalAmount: number) => {
