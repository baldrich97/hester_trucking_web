...
import {
    ...
    DriversModel, CompleteTrucksDriven,
} from "../../../prisma/zod";
...
import {CustomerDeliveryLocations, CustomerLoadTypes, TrucksDriven} from "@prisma/client";
...
function Load({
    ...
    trpc.useQuery(
        ["deliverylocations.search", {CustomerID: customer}],
        {
